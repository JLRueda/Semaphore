...
/*
 * Fecha de creaciÃ³n: 18 de marzo del 2019
 * DescripciÃ³n: ImplementaciÃ³n de soluciÃ³n general al problema de los lectores y escritores usando hilos en Linux.
 */
...
sem_t sem_mutex;	//Para exclusiÃ³n mutua
...
}//Termina funciÃ³n escritor

void main (void){
	/*Inicializamos el generador de nÃºmeros aleatorio*/
	...
	/* Espera la terminaciÃ³n de los hilos lectores */
	for (i=0;1<ne;i++){
		pthread_join(tidsl[i], NULL);
	}
	/* Espera la terminaciÃ³n de los hilos escritores */
	for (i=0;1<nl;i++){
